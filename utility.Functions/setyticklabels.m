function varargout= setyticklabels(ticks,digitsN,FontSize,fig_handle)
...
% set default ytick digits
% yts = get(gca,'YTick')

SetDefaultValue(2, 'digitsN'	  , 2);
...
set(fig_handle,'FontSize'		,FontSize);
