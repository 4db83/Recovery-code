% HLW23_post_COVID19 Shock recovery SSF (https://www.newyorkfed.org/research/policy/rstar)
% --------------------------------------------------------------------------------------------------
...
s1  =  0.452;       % sigma(ytild)                                                                           
s2  =  0.787;       % sigma(pi)                                                                              
s3  =  0.118;       % sigma(z)                                                                               
s4  =  0.500;       % sigma(ystar)                                                                           
s5  =  0.145/4;     % sigma(g)       reported as annualized rate -->                                                
...
D1(1,1) = 1;    D1(1,6) = kappa*s1;
D1(2,2) = -by;  D1(2,7) = kappa*s2;
% Define D2
...
print_table(Pstar,4,1,['    Kappa = ' num2str(kappa)])
...
if PLOT_STATES
  ...
  % print2pdf('HLW23_plots_KS',2); % super slow here
  % exportgraphics(gcf,'HLW23_plots_KS.pdf','ContentType','vector')
end
% --------------------------------------------------------------------------------------------------
