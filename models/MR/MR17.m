...
Q(1,5) = s5;
if ADD_Drstr; Q(end,[3 5]) = [s3 4*s5]; end
% --------------------------------------------------------------------------------------------------
...
if PLOT_STATES
  ...
  % print2pdf('MR17_plots_KS',2); % super slow here
  % exportgraphics(gcf,'MR17_plots_KS.pdf','ContentType','vector')
end
% --------------------------------------------------------------------------------------------------
