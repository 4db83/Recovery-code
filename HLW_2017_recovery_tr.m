% HLW(2017) recovery check. 
% NOTE: It is the same as the covid version, but with slightly different parameters and
% c = 1, kappa = 1 for the pre-covid period, so that the amplifying factor is 1, and phi = 0 but it
% goes into the Zeta(t) observable vector anyway, so we do not need it.
% param
...
% -----------------------------------------------------------------------------------------
% standard deviations
sig_ytild = 0.3338;     % sig_ytild = 0.33378693;
sig_pi    = 0.7862;     % sig_pi    = 0.78620285;
sig_ystar = 0.5739;     % sig_ystar = 0.57390968;
% sig_galready annuallized, ie. multiplied by 4
sig_g     = 0.1230;     % sig_g     = 0.03073865; 
sig_z     = 0.1742;     % sig_z     = 0.17417263;
...
stdev_estdrstar_sm =0.005969530519367221;
...
%% Simulate data for EViews
 ...
 writematrix(dataout,'HLWdata.csv') 
